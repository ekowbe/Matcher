"""Utilities file for a custom QDialog for a match summary and a fixed-width font."""

from PySide6.QtWidgets import QDialog, QDialogButtonBox, QVBoxLayout, QLabel, QLineEdit, QTextEdit
...
class FixedWidthMessageDialog(QDialog):
    ...
    def __init__(self, summary_str: str, parent=None):
        ...
        msg_widget.setPlainText(summary_str)
        ...
        label_widget = QLabel("Which project(s) do you want to cut (Type each number separated by a comma or None if done):")
    ...
    def set_input(self, user_input_edit):
        self.user_picks = user_input_edit.text()
